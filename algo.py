...
def initialize_locations(user_location):
    ...
    charging_stations = {
        'CS1': {'location': [38.203970163579754, 127.15094838695512], 'cost': 1.83, 'available_slots': 7},
        'CS2': {'location': [12.105547003009136, 60.990078654423144], 'cost': 3.99, 'available_slots': 5},
        'CS3': {'location': [23.616600162843056, 73.51152340701071], 'cost': 2.2, 'available_slots': 8},
        'CS4': {'location': [33.0367368280716, 122.08909057573692], 'cost': 2.76, 'available_slots': 2},
        'CS5': {'location': [48.712521903384015, 169.11024780548155], 'cost': 4.13, 'available_slots': 1},
        'CS6': {'location': [-55.438339005707306, -16.399846831359355], 'cost': 1.89, 'available_slots': 7},
